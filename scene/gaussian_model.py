...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int, args):
        ...
        self._deformation_feature= deform_network_feature(args)
    ...
    def capture(self):
        return (
            ...
            self._deformation_feature.state_dict(),
    ...
    def restore(self, model_args, training_args):
       ...
       # self._deformation_feature.load_state_dict(deform_feature_state,strict=False)
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float, semantic_feature_size : int,):
        ...
        self._deformation_feature = self._deformation_feature.to("cuda") 
    ...
    def training_setup(self, training_args):
        ...
        l = [
            ...
            {'params': list(self._deformation_feature.get_mlp_parameters()), 'lr': training_args.deformation_feature_lr_init * self.spatial_lr_scale, "name": "deformation_feature"},
            {'params': list(self._deformation_feature.get_grid_parameters()), 'lr': training_args.grid_lr_init * self.spatial_lr_scale, "name": "deformation_feature_grid"},
    ...
    def load_model(self, path):
        ...
        self._deformation = self._deformation.to("cuda")
        self._deformation_feature.load_state_dict(weight_dict)
        self._deformation_feature = self._deformation_feature.to("cuda")
        self._deformation_table = torch.gt(torch.ones((self.get_xyz.shape[0]),device="cuda"),0)
        self._deformation_accum = torch.zeros((self.get_xyz.shape[0],3),device="cuda")
    ...
    def save_deformation(self, path):
        ...
        torch.save(self._deformation_feature.state_dict(),os.path.join(path, "deformation_feature.pth"))
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_deformation_table, new_semantic_feature):
        d = {"xyz": new_xyz,
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent, density_threshold=20, displacement_scale=20, model_path=None, iteration=None, stage=None):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_deformation_table, new_semantic_feature)
