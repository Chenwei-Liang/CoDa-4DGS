...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.deformation_feature_lr_init = 0.000016
        self.deformation_feature_lr_final = 0.0000016
        self.deformation_feature_lr_delay_mult = 0.01
